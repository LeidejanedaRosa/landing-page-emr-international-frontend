...
const courses: Course[] = [
  {
    ...
    images: {
      ...
      webp: TMRImageWebp,
      jpg: TMRImageJpg,
      alt: 'Socorrista tático aplicando torniquete durante treinamento de combate simulado TMR',
    },
    variant: 'emergency',
  },
  {
    ...
    images: {
      ...
      webp: WMRImageWebp,
      jpg: WMRImageJpg,
      alt: 'Resgatista realizando primeiros socorros e transporte em terreno montanhoso no curso WMR',
    },
    variant: 'wilderness',
  },
]
