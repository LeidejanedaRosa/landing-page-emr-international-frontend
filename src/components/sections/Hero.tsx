        ...
        <div className='text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            ...
            <button
              ...
              className='btn-secondary bg-transparent text-white border-white hover:bg-white hover:text-primary-600 transform hover:scale-105 transition-all duration-300'
            >
              Entre em Contato
            </button>
          </div>
