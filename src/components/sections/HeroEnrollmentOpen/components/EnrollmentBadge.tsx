...
export const EnrollmentBadge: React.FC<EnrollmentBadgeProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 landscape-mobile:px-3 landscape-mobile:py-1.5 landscape-mobile:gap-1.5 sm:px-5 sm:py-2.5 sm:gap-2.5 md:px-4 md:py-2 rounded-full
