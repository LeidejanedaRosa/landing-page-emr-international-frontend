    ...
    return (
      <picture>
        ...
        <img
          ...
          width={800}
          height={600}
          className='w-full h-full object-contain object-top lg:object-cover lg:object-center xl:object-[center_30%] bg-gradient-to-t from-black via-black/20 to-black opacity-90 md:bg-gradient-to-l'
