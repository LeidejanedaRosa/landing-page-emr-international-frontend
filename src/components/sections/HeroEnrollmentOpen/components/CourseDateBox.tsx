...
export const CourseDateBox: React.FC<CourseDateBoxProps> = memo(
  ({ date, month, monthNumber, year, accentColor }) => {
    ...
    return (
      <div
        className={`flex items-center gap-2 md:flex-col md:items-center md:gap-0
                    ${colors.dateBox} backdrop-blur-md rounded-lg
                    px-3 py-2 sm:px-4 sm:py-2.5 md:px-6 md:py-4 lg:px-8 lg:py-6
      ...
      >
        ...
        >
          ...
          <span className='text-base sm:text-lg md:text-sm lg:text-lg font-semibold text-white/90 md:mt-0.5'>
            {year}
          </span>
        </time>
      </div>
