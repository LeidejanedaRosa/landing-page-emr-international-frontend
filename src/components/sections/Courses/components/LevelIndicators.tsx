...
const LevelIndicator = memo(
  ({ label, value, filledColor }: LevelIndicatorProps) => (
...
export const LevelIndicators = memo(
  ({ levelData, styles }: LevelIndicatorsProps) => (
...
LevelIndicators.displayName = 'LevelIndicators'
