...
export const SocialProof = memo<SocialProofProps>(
  ({
    ...
    <div
      className='flex flex-row items-center justify-center text-center gap-3 sm:gap-6 text-gray-400 text-xs sm:text-sm font-medium border-t border-white/10 pt-3 sm:pt-4'
      role='group'
